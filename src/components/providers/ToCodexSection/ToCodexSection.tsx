...
const getToCodexApiKeyEntries = (config: ProviderKeyConfig): ApiKeyEntry[] => {
...
export function ToCodexSection({
  configs,
  keyStats,
    ...
    <Card
      title={
        <span className={styles.cardTitle}>
          ...
          {t('ai_providers.tocodex_title')}
        </span>
      }
      extra={
        <Button size="sm" onClick={onAdd} disabled={actionsDisabled}>
          {t('ai_providers.tocodex_add_button')}
        </Button>
      }
    >
      <ProviderList<ProviderKeyConfig>
        ...
        emptyTitle={t('ai_providers.tocodex_empty_title')}
        emptyDescription={t('ai_providers.tocodex_empty_desc')}
        onEdit={onEdit}
        onDelete={onDelete}
        actionsDisabled={actionsDisabled}
        getRowDisabled={(item) =>
          hasDisableAllModelsRule(item.excludedModels) ||
          getToCodexApiKeyEntries(item).every((entry) => entry.disabled === true)
        }
        ...
        renderContent={(item, index) => {
          ...
          const apiKeyEntries = getToCodexApiKeyEntries(item);
          ...
          return (
            <Fragment>
              <div className="item-title">{t('ai_providers.tocodex_item_title')}</div>
